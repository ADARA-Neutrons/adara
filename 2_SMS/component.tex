...
histogram parameters for use by the translation service. This may be
communicated via a specific packet type (likely) or via the variable
value system.}
