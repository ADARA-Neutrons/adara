...
the prologue defined above and all subsequent data will be associated with that
experimental recording until it receives another Run Status Packet
indicating the completion of the that run.
