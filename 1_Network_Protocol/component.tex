...
bank. There will be one section for each known bank in the detector. The
...
each detector bank known to the system. As defined in
...
on the beam line. The format of the section is given in
Figure~\ref{fig:protocol_monitor_event_section}.
\end{itemize}
...
for each Beam Monitor known to thse system. As defined in
