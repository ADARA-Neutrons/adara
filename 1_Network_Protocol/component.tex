...
Following the {\bf Format} field, there is a 64-bit {bf Timestamp}, broken into
two 32-bit fields. The timestamp gives the seconds (first field) and
...
\begin{figure}
  ...
  \begin{bytefield}{32}
    ...
    \wordbox{1}{Time-of-flight 1} \\
    \wordbox{2}{Time-of-flight 2} \\
    \wordbox[lrt]{1}{Time-of-flight $N$} \\
    \skippedwords \\
    \wordbox[lrb]{1}{}
  \end{bytefield}
