...
\begin{figure}[h]
  ...
  \begin{bytefield}[bitwidth=1em]{32}
    \bitheader{31,0} \\
    \wordbox{1}{Length $4 + 24 N$ (N Sections, 24 bytes each)} \\
...
\begin{figure}[h]
  ...
  \begin{bytefield}[bitwidth=1em]{32}
    \bitheader{31,0} \\
    \wordbox{1}{Length $4 + 28 N$ (N Sections, 28 bytes each)} \\
...
\begin{itemize}
\item{\bf Length} is 16 bytes plus the number
...
\begin{figure}[h]
  ...
  \begin{bytefield}[bitwidth=1em]{32}
    \bitheader{31,0} \\
    \wordbox{1}{16 + 8$M$ + $Sum_i$\{roundup($N[i]$, 4)\}} \\
