...
However, with the information provided in this optional
prologue packet~\footnote{Note that this optional ``Detector Bank Sets''
prologue packet must occur {\it after} the ``Pixel Map Table'' packet
in the prologue, e.g. for the Streaming Translation Service (STS)
to simplify its association of any Detector Bank Sets with the ``BankInfo''
Neutron Detector Banks, which must already have been defined.},
