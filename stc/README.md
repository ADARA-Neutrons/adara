...
4. git push (pushes up to origin/main)
...
4. git checkout main (swiches back to the main branch)
...
2. git pull sts-devel main 
   (feches and merges in changes from the main branch of sts-devel)
3. git push origin main
   (pushes changes back to the original repo, main branch)
